...
function jsCalculator(number1, number2, operation){
    if (operation == "add"){
        console.log("Addition of first number (" + number1 + ") with second number (" + number2 + ") returns: " + myAddfunction(number1, number2));
    }else if (operation == "sub"){
        console.log("Subtraction of first number (" + number1 + ") with second number (" + number2 + ") returns: " + mySubtractFunction(number1, number2));
    }else if (operation == "mul"){
        console.log("Multiplication of first number (" + number1 + ") with second number (" + number2 + ") returns: " + myMultiplicationFunction(number1, number2));
    }else if (operation == "div"){
        console.log("Division of first number (" + number1 + ") with second number (" + number2 + ") returns: " + mydivisionFunction(number1, number2));
    }else{
